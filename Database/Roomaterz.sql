...
CREATE TABLE User(
    ...
    gender VARCHAR(10) DEFAULT 'Man' check (gender IN ('Man', 'Woman')),
    birth_date DATE NOT NULL,
    email VARCHAR (255) NOT NULL,
    phone VARCHAR (30) NOT NULL,
    password VARCHAR(255) NOT NULL,
    profile_img VARCHAR(255) NOT NULL,
    FOREIGN KEY(location) REFERENCES City (id) ON DELETE
...
INSERT INTO
  Type (id, type)
values
  (1, 'i have a house, looking for a roommate'),
  (2, 'looking for someone, to find rent together'),
  (3, 'looking for rent');
CREATE TABLE Post (
    id int UNSIGNED PRIMARY key AUTO_INCREMENT,
    user_id int UNSIGNED NOT NULL,
    type_id int UNSIGNED DEFAULT 3,
    city_id int UNSIGNED DEFAULT 1 ,
    description varchar(255) NOT NULL CHECK (
      CHAR_LENGTH (description) > 10
      AND CHAR_LENGTH (description) < 255),
...
INSERT INTO City (id, location) VALUES
(1,'Aïn Harrouda'),
(2, 'Ben Yakhlef'),
(3, 'Bouskoura'),
(4, 'Casablanca'),
